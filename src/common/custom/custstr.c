...
#include "rpi.h"
#include "util.h"
// No <string.h>: freestanding kernel — util.h provides our memset/memcpy.
...
// strcmp_ret — when case_agnostic is non-zero, fold ASCII A-Z / a-z to a
// common case before comparing each byte. Non-letters are compared as-is.
